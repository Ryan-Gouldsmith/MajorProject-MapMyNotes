...
class TestMetaDataForm(LiveServerTestCase):
    ...
    def test_form_exists(self):
        self.driver.get(self.get_server_url() + "/upload/show_note/test.png")
    ...
    def test_form_has_module_field(self):
        self.driver.get(self.get_server_url() + "/upload/show_note/test.png")
        module_field = self.driver.find_element_by_class_name("module_code")
