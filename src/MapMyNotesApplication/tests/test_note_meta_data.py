...
class TestNoteMetaData(TestCase):
    ...
    def test_saving_a_lecturers_name_should_return_correct_name(self):
        ...
        meta_data = NoteMetaData("Dr Test", module_code.id, "C11 Hugh Owen", date, "Title")
        database.session.add(meta_data)
        database.session.commit()

        database_meta_data = NoteMetaData.query.first()
    ...
    def test_a_name_which_is_too_long_should_return_false(self):
        ...
        meta_data = NoteMetaData(too_long_lecturers_name, module_code.id, "C11 Hugh Owen", date, "Title")
    ...
    def test_a_name_which_is_fine_for_length_should_return_true(self):
        ...
        meta_data = NoteMetaData(lecturer_name, module_code.id, "C11 Hugh Owen", date, "Title")
    ...
    def test_that_location_cant_be_over_100_characters(self):
        ...
        meta_data = NoteMetaData("Dr Test", module_code.id, location, date, 'Title')
    ...
    def test_find_existing_meta_data_should_return_that_instance(self):
        ...
        found_example = NoteMetaData.find_meta_data(meta_data)

        assert type(found_example) is NoteMetaData
    ...
    def test_find_exisitig_meta_data_should_return_none_bad_data(self):
        ...
        bad_meta_data = NoteMetaData("Dr Bad", module_code.id, "C11 Hugh Owen", date, 'A Title')

        found_example = NoteMetaData.find_meta_data(bad_meta_data)
    ...
    def test_saving_a_new_module_code_updates_current_object_module_code(self):
        ...
        module_code_new = ModuleCode("SE31520")
